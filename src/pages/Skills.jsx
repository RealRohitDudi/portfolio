  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Responsive Design', icon: FiLayout, level: 90, color: '#4A90E2' },
        { name: 'User Experience', icon: FiLayout, level: 85, color: '#9B59B6' },
      ],
    },
    {
      title: 'DevOps & Tools',
      ...
      skills: [
        ...
        { name: 'AWS', icon: FaAws, level: 75, color: '#232F3E' },
      ],
    },
  ];
